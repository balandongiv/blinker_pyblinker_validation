...
This is similar to step4_compare_pyblinker_vs_blinker.py but compares pylinker vs the visualization-based annotations.
...
The pyblinker input is the filename 'pyblinker_results.pkl' located in the same folder as the CSV files.
