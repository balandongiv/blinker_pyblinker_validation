"""Archived comparator for MATLAB Blinker vs visualization-derived annotations.
...
from tutorial.murat_sequence.legacy.step5_compare_viz_vs_pyblinker_legacy import (  # noqa: E402 - shared helpers
