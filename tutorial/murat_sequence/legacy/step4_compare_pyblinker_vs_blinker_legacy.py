"""Archived comparator for PyBlinker vs MATLAB Blinker results.

This script is kept for historical reference only. The canonical public
validation flow now lives under :mod:`src.validation`.
"""
